...
const form = useForm({
    output_date: new Date().toISOString().slice(0, 10), // Default to today
    comment: '',
    items: [] as {
...
const submit = () => {
    // Basic frontend validation before submitting
...
<template>
    <Head title="Yangi Chiqim" />

    <AppLayout>
        <div class="p-4 md:p-8">
            <Card>
                <CardHeader>
                    <CardTitle>Yangi Chiqim Yaratish</CardTitle>
                </CardHeader>
                <CardContent>

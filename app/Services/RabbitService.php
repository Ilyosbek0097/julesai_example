...
class RabbitService
{
    ...
    public function publishMessage(string $messageBody, string $routingKey = 'acp', string $exchange = null, string $exchangeType = 'direct')
    {
        try {
